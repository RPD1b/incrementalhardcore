...
## ReviveHealth ----------
#Set
execute if score ReviveHealth INH.Settings matches 2..20 run tellraw @s [{"text":"Revive Health: ","hoverEvent":{"action":"show_text","contents":["The number of half-hearts a revived player will spawn with","\nDefault: ",{"text":"2","color": "blue"},"\nAccepts Values: ",{"text":"2-20","color":"blue"}]}},{"score":{"name":"ReviveHealth","objective":"INH.Settings"},"color":"#0010e6"}]
#Backup in case it is unset, somehow.
